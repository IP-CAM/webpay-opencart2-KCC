...
class ControllerPaymentWebpayOCCL extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['webpay_occl_return_policy'])) {
			$data['webpay_occl_return_policy'] = $this->request->post['webpay_occl_return_policy'];
		} else {
			$data['webpay_occl_return_policy'] = $this->config->get('webpay_occl_return_policy'); 
		}
		...
		$data['callback'] = HTTP_CATALOG . 'index.php?route=payment/webpay_occl/callback';
